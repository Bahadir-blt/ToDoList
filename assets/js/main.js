//! selectors
const todoInput = document.querySelector(".todo-input");  // querySelector() yöntemi, belgede belirtilen bir CSS seçiciyle eşleşen ilk öğeyi döndürür.//
